...
public class JOrdenaNumberFrame extends JFrame { 
	...
	public JOrdenaNumberFrame() { 
		setIconImage(Toolkit.getDefaultToolkit().getImage(JOrdenaNumberFrame.class.getResource("/javax/swing/plaf/metal/icons/ocean/file.gif"))); setTitle("Ordenar n\u00FAmeros"); setVisible(true); setResizable(false); 
