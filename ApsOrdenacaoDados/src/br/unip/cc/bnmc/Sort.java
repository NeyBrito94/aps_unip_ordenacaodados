...
public class Sort { 
	...
	public Sort() { 
		...
		nElems = 0; } public void insert(Imagem value, String nome) { 
    ...
    public static DefaultListModel dadosIma() { 
    	...
    	for(int i = 0; i < theArrayIm.size(); i++) 
    		DLM.addElement(theArrayIm.get(i).getNome() + " " + theArrayIm.get(i).getWidth() + " " + theArrayIm.get(i).getHeight()); return DLM; 
    		} 
